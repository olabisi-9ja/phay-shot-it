...
export const COLLECTIONS: Collection[] = [
  ...
  },
  {
    ...
    index: "02",
    name: "PLACES",
    line: "Lagos & Ilorin, when they think nobody is looking.",
    years: "2024 — 2026",
    photos: pick("lagoon", "lagoonWide", "rainReflections", "neonBar"),
  },
  {
    id: "nocturne",
    index: "03",
    ...
    years: "2025 — 2026",
    photos: pick("heroRain", "neonBar", "trumpeterMono", "rainReflections"),
  },
  {
    id: "motion",
    index: "04",
...
export const MAP_NODES: MapNode[] = [
  ...
  },
  {
    id: "ilorin",
    city: "ILORIN",
    coords: '8°32′N 4°34′E',
    years: "2022 — NOW",
    x: 49,
    y: 55,
    photo: PHOTOS.adaeze,
    photos: pick("adaeze", "studioRed", "fisherman", "craftsman"),
  },
];
...
export const JOURNAL: JournalEntry[] = [
  ...
  },
  {
    ...
    date: "30.04.2026",
    read: "5 MIN",
    excerpt: "Notes from nights in the city, where the rain edits the light for you.",
    body: [
      "Lagos was the first city that made me slow down without asking me to be quiet. The alleys do the composition for you — every wire, every sign, every umbrella is already placed. Your job is only to arrive at the correct hour and not blink.",
      ...
      "Lesson I carried between Lagos and Ilorin: the background is never waiting politely. It is performing too. Focus past your subject sometimes and let the city have the frame.",
    ],
    photo: PHOTOS.lagoon,
  },
  {
