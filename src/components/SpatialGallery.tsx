 ...
 */
const TILES: Tile[] = [
  { photo: PHOTOS.craftsman,       x: 7,  y: 6,  w: 15, depth: 2 },
  { photo: PHOTOS.adaeze,          x: 23, y: 2,  w: 12, depth: 3 },
  { photo: PHOTOS.spiral,          x: 40, y: 8,  w: 24, depth: 1 },
  { photo: PHOTOS.sahara,          x: 68, y: 4,  w: 9,  depth: 2 },
  { photo: PHOTOS.tokyo,           x: 80, y: 12, w: 13, depth: 3 },
  { photo: PHOTOS.lagoon,          x: 9,  y: 42, w: 21, depth: 1 },
  { photo: PHOTOS.studioRed,       x: 33, y: 38, w: 13, depth: 3 },
  { photo: PHOTOS.handsDetail,     x: 52, y: 52, w: 12, depth: 2 },
  { photo: PHOTOS.trumpeter,       x: 68, y: 42, w: 14, depth: 2 },
