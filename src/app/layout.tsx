...
export const metadata: Metadata = {
  ...
  keywords: [
    "Photographer in Ilorin",
    "Photographer in Lagos",
    "Photography in Ilorin",
    "Photography in Lagos",
    "Convocation photographer Ilorin",
    "Portrait photographer Ilorin",
    "Event photographer Ilorin",
    "Lifestyle photographer Lagos",
    "Brand photographer Lagos",
